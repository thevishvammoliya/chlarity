              ...
              <div className={styles.aboutContainer}>
                ...
                <div className={styles.aboutContent}>
                  <p>
                    ...
                    lives of people in need. Chlarity is a blockchain-based
                    charity platform that is dedicated to providing charitable
                    funds to those in need of medical treatment. Our mission is
                    to bring transparency and security to the charity industry,
                    and to make it easy for donors to contribute to worthy
                    causes.
                  </p>
                  <p>
